...
public class HashMachine extends Close {
	...
	public void start(String user) {
		...
		try {
			...
			reset();
			path = new Path(user); // Parse the user text into a Path
			hash = new HashTask(update, path, null, null);
	...
	public class MyModel extends Model {
		...
		public String status() {
			if (exception != null) {
				if (exception instanceof MessageException) return "Cannot Open File";
